...
/**
 ...
 @param response        Reference on HTTP response from \b PubNub service for \c request sent by
                        client.
 @param request         Reference on request which has been used to communicate with \b PubNub
                        service.
 @param serviceResponse Reference on original not pre-processed \b PubNub service response (w/o
                        headers).
 @param responseObject  Reference on pre-processed data received from service.
 @param error           Reference on \a NSError instance in case if any issues appeared while
                        request was on processing.
